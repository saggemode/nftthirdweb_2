...
const API_KEY = "9f1b9600ca7cd548aaee207b";
const URL = `https://v6.exchangerate-api.com/v6/${API_KEY}/pair/USD/NGN`;

export const useExchangeRateGBPToIRR = (price: number) => {
  const [exchangePrice, setExchangePrice] = useState<number>(0);
  const hardRateExchange = 443.87; // each Pound into Rial
  useEffect(() => {
